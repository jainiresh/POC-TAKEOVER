...
var _InspectorTracebackNamespace = require("./InspectorTracebackNamespace");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const DEFAULT_TRACEBACK_LIMIT = 1000;
const DEFAULT_FRAMES_LIMIT = 100; // Note - this is a serious duplication of the V8StackNamespace
...
class InspectorStackNamespace extends _Namespace.default {
  ...
  traceback(args) {
    ...
    return new _InspectorTracebackNamespace.InspectorTracebackNamespace(this.inspector, this.callFrames, depth);
  }
