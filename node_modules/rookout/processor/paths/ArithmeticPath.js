...
class Marker {
  ...
  read(namespace, create) {
    throw new _RookError.default(null, "Read not implemented");
  }
...
class LookupOperation extends Marker {
  ...
  write(namespace, value) {
    throw new _exceptions.RookOperationReadOnly("LookupOperation");
  }
...
class OperationList extends Marker {
  ...
  write(namespace, value) {
    ...
    if (size === 0) {
      throw new exceptions.RookInvalidArithmeticPath(this.expression || "Null expression", null);
    } // execute the operation chain.
...
class ToolException_ extends ObjectMarker {
  constructor(exc) {
    super();
    this.obj = exc;
  }
...
class Nan extends ObjectMarker {
  constructor() {
    super();
    this.obj = NaN;
  }
...
const _opMap = new Map([["+", function (a, b) {
  ...
  return a >= b;
}], ["!=", notEquals], ["!==", notEquals], ["=", equals], ["==", equals], ["===", equals], //"in": function(a, b) { return a in b; },lambda a, b: a in b,  # should use this...
["&&", function (a, b) {
  return a && b;
}], ["||", function (a, b) {
  return a || b;
...
class actions {
  ...
  make_nan(input, start, end, elements) {
    return nanInstance;
  }
