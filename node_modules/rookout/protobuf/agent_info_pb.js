...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.com.rookout.AgentInformation.toObject = function (includeInstance, msg) {
    var f,
      ...
      sdkConfigMap: (f = msg.getSdkConfigMap()) ? f.toObject(includeInstance, undefined) : []
    };
...
proto.com.rookout.AgentInformation.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getSdkConfigMap(true);
...
/**
 * map<string, string> sdk_config = 12;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,string>}
 */
...
proto.com.rookout.AgentInformation.prototype.getSdkConfigMap = function (opt_noLazyCreate) {
  return (
    /** @type {!jspb.Map<string,string>} */
...
proto.com.rookout.AgentInformation.prototype.clearSdkConfigMap = function () {
  this.getSdkConfigMap().clear();
  return this;
};
/**
 * List of repeated fields within this message type.
