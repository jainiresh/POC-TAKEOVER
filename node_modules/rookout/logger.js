...
class Logger {
  constructor() {
    const canonizedJestName = (0, _utils.canonizeFileName)('rooks/node/rook/node_modules/jest/bin/jest.js');

    if (process.argv.length > 1 && (0, _utils.canonizeFileName)(process.argv[1]).endsWith(canonizedJestName) && process.env.ROOKOUT_TEST_ENVIRONMENT) {
